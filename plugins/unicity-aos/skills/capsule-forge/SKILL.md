...
- **Forge tool (when the running AOS grants this Codex principal the Forge
  capsule):** call
...
This plugin ships the Skill. When the **forge** capsule is installed and granted
to `codex-code`, AOS bridges its tools into this Codex session over MCP:
...
If those tools are absent, inspect the live AOS grants and capsule inventory.
The CLI and by-hand paths above still explain how to author the artifact, but do
